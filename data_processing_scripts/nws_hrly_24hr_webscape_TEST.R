...
#set up dirs:local pc
#raw_page_wd<-"C:\\Users\\mpluc\\OneDrive\\Documents\\jets_stream_outputs\\nws_hrly_work\\raw_scrap\\html_text"
#parse_hrly_wd<-"C:\\Users\\mpluc\\OneDrive\\Documents\\jets_stream_outputs\\nws_hrly_work\\parse_hrly"
#agg_daily_wd<-"C:\\Users\\mpluc\\OneDrive\\Documents\\jets_stream_outputs\\nws_hrly_work\\parse_daily"

#set up dirs:server
raw_page_wd<-"/home/mplucas/data/raw/nws/raw_files/hourly_nws"
parse_hrly_wd<-"/home/mplucas/data/raw/nws/parsed_data/hourly_nws"
agg_daily_wd<-"/home/mplucas/data/raw/nws/daily_agg"
...
zip(zipfile = paste0(getwd(),"/zipped_html/nws_hrly_rf_html_",format(Sys.Date()-1,"%Y_%m_%d")), files = files2zip)#zip and/or append raw html files
...
rf_month_daily_filename<-paste0("nws_24hr_daily_",format((Sys.Date()-1),"%Y_%m"),".csv")#dynamic filename that includes month year so when month is done new file is writen
